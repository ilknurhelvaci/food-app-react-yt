  ...
  return (
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px'>
            ...
            <img className='w-full max-h-[500px] object-cover' src="https://images.pexels.com/photos/326278/pexels-photo-326278.jpeg?auto=compress&cs=tinysrgb&w=600" alt="foods" />
        </div>
